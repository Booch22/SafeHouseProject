...
path_of_frame = 'Benchmark_Normal_Frames/frame535.jpg'
print( path_of_frame )
my_image = cv2.imread( path_of_frame )



# เริ่มตรวจจับและวัดหมุด
start_program( my_image )
